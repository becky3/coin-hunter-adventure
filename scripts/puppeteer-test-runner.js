/**
 * Puppeteerを使用した実際のブラウザでのテスト実行
 * 実際のブラウザ環境でJavaScriptを実行してテスト結果を取得
 */
...
async function runPuppeteerTest() {
    ...
    try {
        ...
        if (!initialized) {
            return { success: false, error: 'Puppeteer初期化失敗' };
        }
